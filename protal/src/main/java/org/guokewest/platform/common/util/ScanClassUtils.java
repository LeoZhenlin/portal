package org.guokewest.platform.common.util;
...
public class ScanClassUtils { 
	/**
	 * 根据多个包名搜索class
	 * 例如: ScanClassUtils.scanPakcages("javaorg.guokewest.platform.common.**.*");
	...
	public static List<String> scanPackages(String basePackages) throws IllegalArgumentException{
		...
		try {
			...
			throw new IllegalArgumentException("scan pakcage class error,pakcages:"+basePackages);
		}
