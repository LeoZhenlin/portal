...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/wxbuttonController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<th>排序</th>
					<td>
						<input name="seq" value="8" class="easyui-numberspinner" style="width: 140px; height: 29px;" required="required" data-options="editable:false,min:8">
					</td>
				</tr>
				<tr>
					<th>EventKey</th>
					<td><input id="key" name="key" type="text" placeholder="请输入EventKey" class="easyui-validatebox span2" value=""></td>
					<th>View URL</th>
					<td><input id="url" name="url" type="text" placeholder="请输入URL" class="easyui-validatebox span2" value="" /></td>
				</tr>
				<tr>
					<th>备注</th>
