...
<!-- <link rel="stylesheet" href="${ctx}/jslib/jquery-easyui-1.3.3/themes/icon.css" type="text/css"> -->
...
<script type="text/javascript" src="${ctx}/jslib/protalUtil.js" charset="utf-8"></script>
